...
<section id="contact" class="contact-person-section mt-2 mt-lg-3 mb-2 mb-lg-3">
    <div class="container">
        <header>
            <h2 class="base-heading"><?php echo $ThemeSettings->getTitleContactPerson();?></h2>
        </header>

        <div class="row justify-content-center">
            <div class="col-sm-6 col-md-4 col-lg-3 lecturer-block">
                <div class="lecturer-block__inner">
                    <div class="lecturer-block__img lecturer-block__img--same-size"><img src="<?php echo Util::getImageSrc($ThemeSettings->getContactPersonPhoto(), IMAGE_SIZE_192x192);?>" alt="person" /></div>
