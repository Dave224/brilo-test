...
class PageFrontConfig implements \KT_Configable
{
    ...
    {
        $fieldset = new \KT_Form_Fieldset(self::INTRO_FIELDSET, __("Intro", "WPA_DOMAIN"));
        $fieldset->setPostPrefix(self::INTRO_FIELDSET);

        $fieldset->addText(self::INTRO_TITLE, __("Titulek:", "WPA_DOMAIN"));
        $fieldset->addText(self::INTRO_DESCRIPTION, __("Popisek", "WPA_DOMAIN"));
        $fieldset->addWpPage(self::INTRO_PAGE_ID, __("Naše služby:", "WPA_DOMAIN"))
            ->setFirstEmpty();
